...
public class UserRepositoryImpl implements UserCustom {
    ...
    public List<UserAddress> selectAddressList(Long userId) {
        String sql = "SELECT a.id, a.country_id, a.user_type, a.company, a.contact_name, a.sender_default, a.receipient_default," +
                " a.address1, a.address2, a.city_id, ci.city_name, ci.postal_code, co.country_name, ci.state_province  " +
