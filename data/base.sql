...
ALTER TABLE transaction ADD FULLTEXT (carier_name,package_type,contact_sender,tracking_no,dest_country,content_type,recipient_address1,recipient_address2,sender_address1,sender_address2, sender_phone_number, recipient_phone_number);
